    ...
    <div className="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
      <form action="success.html">
        ...
        <div className="flex flex-col mb-4">
          ...
          <input data-input type="text" id="complete-name" className="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
